        ...
        <div className="mx-auto -mt-20 max-w-screen-xl px-4 pb-8 pt-16 sm:px-6 lg:px-8">
          {/* <div className="mx-auto max-w-md">
            <strong className="block text-center text-xl font-bold text-gray-500 sm:text-3xl">
              Want us to email you with the latest travel updates?
            </strong>
            ...
            <form className="mt-6">
              <div className="relative max-w-lg">
                ...
                <input
                  className="w-full rounded-full border-gray-100 bg-gray-50 p-4 pe-32 text-sm font-medium"
                  id="email"
                  type="email"
                  placeholder="elara@travels.com"
                />
            ...
            <div className="grid grid-cols-1 gap-8 text-center lg:grid-cols-3 lg:text-left">
              <div>
                ...
                <ul className="mt-6 space-y-1">
                  <li>
                    <a className="text-gray-50 transition hover:text-gray-50/75" href="/"> Coronavirus (COVID-19) FAQs
          ...
          <div className="mt-16 border-t border-gray-100 pt-8 flex flex-col md:flex-row items-center justify-between gap-4 text-center md:text-left">
            ...
            <p className="flex items-center gap-1 text-sm md:text-base">
              <a
                href="https://www.linkedin.com/in/iamafridi/"
                target="_blank"
                rel="noreferrer"
            ...
            {/* Creator Info */}
            <p className="flex flex-col md:flex-row items-center gap-2 text-gray-50 transition hover:text-gray-50/75 text-sm md:text-base">
