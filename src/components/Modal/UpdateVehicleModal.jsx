...
const UpdateVehicleModal = ({ setIsEditModalOpen, isOpen, refetch, vehicle, id }) => {
  ...
  const handleImageUpdate = image => {
    ...
    imageUpload(image)
      .then(res => {
        setVehicleData({ ...vehicleData, image: res.data.display_url })
        setLoading(false)
      })
      .catch(err => {
        console.log(err)
  ...
  const handleSubmit = event => {
    ...
    const updatedData = Object.assign({}, { ...vehicleData })
    delete updatedData._id
    setLoading(true)
    updateVehicle(updatedData, id)
      .then(data => {
        console.log(data)
